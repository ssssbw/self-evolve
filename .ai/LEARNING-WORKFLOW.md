...
- 当前工作日主线为 P001 和 P004：工作日 2 天 P001、3 天 P004；P002 和 P003 放到周末自行安排。
- 新项目须在已有项目归档、暂停或降为维护后再创建。
...
1. 读取当前周每日记录、P001/P004、周末维护项目、读书清单和本周 Git 变化。
2. 对缺失信息先询问用户，不根据文件变化推测掌握情况。
3. 复盘技术、理财、认知、职业资产、资产记录和健康执行。
4. 将结果区分为“已掌握”“接触过”“未执行”。
5. 汇总完成情况、关键收获、主要阻塞和未解决问题。
6. 保留当前周节奏：工作日 2 天 P001、3 天 P004；P002/P003 周末自选维护。只确定下周最重要的 1-3 件事。
...
- P001、P002、P003、P004、读书清单和路线图仅在达到明确通关条件并再次确认后更新。
