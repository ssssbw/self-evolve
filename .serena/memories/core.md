...
- Markdown personal knowledge base organized by PARA plus `guideline/` for long-horizon plans.
- Primary content source is repository Markdown; Trilium is treated as archive/sync target, not canonical source.
- Top-level map: `0-Projects/` active projects, `1-Areas/` long-term domains, `2-Resources/` references, `3-Archive/` inactive/completed material, `4-Journal/` reviews, `5-Playground/` homework/discussion, `.ai/` handoff context.
