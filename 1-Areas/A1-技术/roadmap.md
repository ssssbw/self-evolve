...
> 本文描述长期技术方向，不是当前日程。具体执行顺序和投入时间以[活跃项目](../../0-Projects/_index.md)、P001 计划及最新周复盘为准；下方时间建议仅作参考，不覆盖当前 `2121` 节奏。
...
- 编译原理
  ...
  - 进度：⬜
- 软件设计基础
  - WHAT & WHY：掌握 SOLID（5 个核心面向对象设计原则），并配合 DRY / KISS / YAGNI 等通用工程原则，再进入常用设计模式，写出可维护、可扩展的代码。是提升代码质量的最快路径。
  - 推荐资源：
    - 《Head First 设计模式》
    - 《设计模式》- GoF（经典）
